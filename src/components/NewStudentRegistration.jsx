                        ...
                        <div className="reg-step-content">
                            ...
                            {showEntranceExplain && (
                                <div className="reg-entrance-explain">
                                    ...
                                    <p><strong>모든 신규 수강생분은 정규 수업 참여에 앞서 입학반을 필수로 이수해야 합니다(입학반 수강 후 정규 수업 출석 가능).</strong> 수업은 바쁜 일정을 고려하여 <strong>주말 중 단 하루, 3시간(이론 1시간 + 자세 실습 2시간)</strong> 동안 압축적으로 진행됩니다.</p>
                                </div>
                            )}
